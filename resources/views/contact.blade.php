...
<section class="py-10 sm:py-16">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-2xl mx-auto text-center">
            ...
            <p class="max-w-xl font-paragraph-textaph-text mx-auto mt-4 text-base leading-relaxed text-gray-500">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis.</p>
        </div>
        ...
        <div class="max-w-5xl mx-auto mt-12 sm:mt-16">
            <div class="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                <div class="overflow-hidden bg-white rounded-xl shadow-lg">
                    <div class="p-6">
                        ...
                        <p class="mt-6 text-lg font-paragraph-text text-gray-900">+1-316-555-0116</p>
                        <p class="mt-1 text-lg font-paragraph-text text-gray-900">+1-446-526-0117</p>
                    </div>
                </div>
                ...
                <div class="overflow-hidden bg-white rounded-xl shadow-lg">
                    <div class="p-6">
                        ...
                        <p class="mt-6 text-lg font-paragraph-text text-gray-900">contact@example.com</p>
                        <p class="mt-1 text-lg font-paragraph-text text-gray-900">hr@example.com</p>
                    </div>
                </div>
                ...
                <div class="overflow-hidden bg-white rounded-xl shadow-lg">
                    <div class="p-6">
                        ...
                        <p class="mt-6 text-lg font-paragraph-text leading-relaxed text-gray-900">8502 Preston Rd. Ingle, Maine 98380, USA</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 overflow-hidden bg-white rounded-xl shadow-2xl">
                <div class="px-6 py-12 sm:p-12">
                    <h3 class="text-3xl font-paragraph-textld text-center text-green-900">Send us a message</h3>
                    ...
                    <form action="#" method="POST" class="mt-14">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                            ...
                            <div>
                                <label for="" class="text-base font-paragraph-text text-gray-900"> Phone number </label>
                                <div class="mt-2.5 relative">
                            ...
                            <div>
                                <label for="" class="text-base font-paragraph-text text-gray-900"> Company name </label>
                                <div class="mt-2.5 relative">
                                    <input type="text" name="" id="" placeholder="Enter your full name" class="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                <label for="" class="text-base font-paragraph-text text-gray-900"> Message </label>
                                <div class="mt-2.5 relative">
